...
@Service
public class PatientSymptomeService {
    ...
    public PatientSymptomeService(PatientSymptomeRepository patientSymptomeRepository,
    ...
    public PatientSymptome ajouterSymptomeAuPatient(Long idPatient, Long idSymptome) {
        if (patientSymptomeRepository.existsByPatientIdUtilisateurAndSymptomeIdSymptome(idPatient, idSymptome)) {
